...
def run_ground_robot_arm(n_steps=1000, render=False, obstacles=False, goal=False):
    """
    ...
    """
    env = gym.make("ground-robot-arm-vel-v0", render=render, dt=0.01)
...
if __name__ == "__main__":
    run_ground_robot_arm(render=True, obstacles=True)
